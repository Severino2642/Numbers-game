using DesChiffres.Models.entity;
...
namespace DesChiffres.Controllers
{
    ...
    public class GameController : Controller
    {
        ...
        public ActionResult<int> getClosestNumber(int guessNumber, string listNumber)
        {
            ...
            int result = number.FindBestClosest(list_chiffre, guessNumber);
            var data = new { number = result , listNumber = number.BestClosest , listExpression = number.BestExpression };
            return Ok(data);
        }
